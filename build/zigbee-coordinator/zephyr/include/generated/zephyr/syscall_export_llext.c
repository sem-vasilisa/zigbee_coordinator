...
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_is_counting_up;
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_get_num_of_channels;
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_get_frequency;
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_us_to_ticks;
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_ticks_to_us;
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_get_max_top_value;
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_start;
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_stop;
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_get_value;
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_get_value_64;
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_set_channel_alarm;
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_cancel_channel_alarm;
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_set_top_value;
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_get_pending_int;
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_get_top_value;
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_set_guard_period;
extern __weak ALIAS_OF(no_handler) void * const z_impl_counter_get_guard_period;
